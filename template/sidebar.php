                        ...
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="../process/barang_data.php">
                                            <i class="nav-main-link-icon si si-layers"></i>
                                            <span class="nav-main-link-name">Data barang</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="../process/suplier_data.php">
                                            <i class="nav-main-link-icon si si-layers"></i>
                                            <span class="nav-main-link-name">Data suplier</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="../process/transaksi_keluar.php">
                                            <i class="nav-main-link-icon si si-basket"></i>
                            ...
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="../process/report_penjualan.php">
                                            <i class="nav-main-link-icon si si-book-open"></i>
                                            <span class="nav-main-link-name">Report penjualan</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
